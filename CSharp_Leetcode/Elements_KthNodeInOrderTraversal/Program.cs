...
namespace Elements_KthNodeInOrderTraversal
{
    public class BtreeNode
    {
        ...
        public void  KthNodeInOrderTraversal(BtreeNode root, int k)
        {
            if (root == null)
            {
                return;
            ...
            KthNodeInOrderTraversal(root.left, k);
            KthNodeInOrderTraversal(root, k);
            KthNodeInOrderTraversal(root.right, k);
        }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            node.KthNodeInOrderTraversal(root, 5);
        }
    }
}
